...
export const LogoIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M7 10H11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <path d="M7 14H13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <path d="M17 9L18 10L19 9L18 11L19 13L18 12L17 13L18 11L17 9Z" fill="currentColor" />
    <path d="M3 12H21" stroke="currentColor" strokeWidth="1" strokeDasharray="2 2" opacity="0.5" />
  </svg>
);
