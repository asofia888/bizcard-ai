...
export const CardListView: React.FC<CardListViewProps> = ({
  ...
  return (
    <>
      ...
      <label
        aria-label="名刺ファイルを追加"
        className="absolute bottom-[calc(1.5rem+env(safe-area-inset-bottom))] right-6 z-30 w-14 h-14 bg-gradient-to-br from-brand-500 to-brand-700 hover:from-brand-600 hover:to-brand-800 text-white rounded-2xl shadow-xl shadow-brand-300 flex items-center justify-center active:scale-90 transition-all cursor-pointer"
      >
